...
1. Download the npm tarball package and unzip e.g.
   ```
   npm pack rabin-native@latest | xargs tar -zxvf
   ```
...
1. Navigate to the
   [Generate Prebuilds workflow](https://github.com/digidem/rabin-native-nodejs-mobile/actions/workflows/prebuilds.yml)
